...
# -*- coding: utf-8 -*-
#
# Tweet_browser_frontend documentation build configuration file
#
...
project = 'Tweet_browser_frontend'
copyright = '2023, Erik Zhou'
author = 'Erik Zhou'
...
_version_py = os.path.join(repo, 'Tweet_browser_frontend', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'Tweet_browser_frontenddoc'
...
latex_documents = [
    (master_doc, 'Tweet_browser_frontend.tex', 'Tweet_browser_frontend Documentation',
     'Erik Zhou', 'manual'),
]
...
man_pages = [
    ...
    'Tweet_browser_frontend Documentation',
     [author], 1)
]
