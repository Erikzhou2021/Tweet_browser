...
c.NotebookApp.tornado_settings = {"websocket_max_message_size": 100 * 1024 * 1024} # found from online, also at around line 580
...
#  Default: 'erikzhou2021'
# c.Session.username = 'erikzhou2021'
...
#  Choices: any of ['sha512', 'sha256', 'blake2b', 'sha3_256', 'sha3_384', 'md5', 'sha1', 'blake2s', 'sha3_224', 'sha224', 'sha3_512', 'sha384']
#  Default: 'sha256'
